...
Loaded `+p+" of "+x+" files.")},n.onError=function(h){console.log("There was an error loading "+h)};const i=new aw,r=new _n(75,window.innerWidth/window.innerHeight,.1,1e3),s=new ow;s.setSize(window.innerWidth,window.innerHeight),s.setClearColor(0,0),t.current.appendChild(s.domElement);const o=new Aw(r,s.domElement);o.addEventListener("change",d),r.position.set(20,20,100);const a=new mw(16777215,1);i.add(a);const l=new pw(16777215,.5);l.position.set(10,20,10),i.add(l),new Ew(n).load("/ProductionLine.mtl",h=>{h.preload();const p=new Mw(n);p.setMaterials(h),p.load("/ProductionLine.obj",x=>{x.scale.set(25,25,25);const m=new Us().setFromObject(x).getCenter(new U);x.position.sub(m),i.add(x),d()})});function f(){e.current=!1,o.update(),s.render(i,r)}function d(){e.current||(e.current=!0,requestAnimationFrame(f))}return d(),()=>{o.removeEventListener("change",d),t.current.removeChild(s.domElement),i.traverse(h=>{h.isMesh&&(h.geometry.dispose(),h.material.dispose())}),s.dispose()}},[]),po.jsx("div",{ref:t})}function Cw(){return po.jsx("div",{className:"App",children:po.jsx(Rw,{})})}su.createRoot(document.getElementById("root")).render(po.jsx(xv.StrictMode,{children:po.jsx(Cw,{})}));
